...
class Promo < Data.define(:title, :text, :cta, :icon, :route,
                          ...
                          :text_left, :text_width, :align, :title_width)
  def self.all
    [
      new(title: "Изучи полезные статьи",
          ...
          text_left: "47.333%", text_width: "46.667%", align: "right", title_width: nil),
      new(title: "Откликнись сам стать временным хозяином",
          ...
          text_left: "16.237%", text_width: "67.526%", align: "center", title_width: nil),
      new(title: "Найди временных хозяев",
          ...
          text_left: "6.000%", text_width: "51.943%", align: "left", title_width: nil)
    ]
  end
end
